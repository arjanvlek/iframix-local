...
| (Web)App Version       | Photos | Photos + AI | Flip Clock      | Weather Station | iCharGuard | Power Save Mode | Calendar | Uses HTTPS? | App MQTT Address           | Charger MQTT Address |
|------------------------|--------|-------------|-----------------|-----------------|------------|-----------------|----------|-------------|----------------------------|----------------------|
| 2.2.29                 | YES    | YES *1      | YES ( 5 styles) | YES (4 styles)  | YES        | YES             | YES *2   | YES         | wss://<host>:443/websocket | TCP <host>:1883      |
| 2.2.27                 | YES    | YES *1      | YES ( 1 style)  | YES (1 style)   | YES        | YES             | YES *2   | YES         | wss://<host>:443/websocket | TCP <host>:1883      |
| 2.1.3                  | YES    | YES *1      | YES ( 1 style)  | YES (1 style)   | YES        | YES             | NO       | NO          | ws://<host>:8083/mqtt      | TCP <host>:1883      |
| Ultra-Legacy iPad 1 *3 | YES    | YES *1      | NO              | NO              | YES        | NO              | NO       | YES         | NOT USED                   | TCP <host>:1883      |
