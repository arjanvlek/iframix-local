...
|------------------------------|--------------------|------------------------|-----------------|-----------------------|---------------------|------------------------------|
| 2.3.1                        | YES                | NO (rejects SSL cert)  | YES             | NO (rejects SSL cert) | YES                 | YES                          |
...
|------------------------|--------|-------------|-----------------|-----------------|------------|-----------------|----------|---------------|-------------|----------------------------|----------------------|
| 2.3.1                  | YES    | YES *1      | YES ( 5 styles) | YES (4 styles)  | YES        | YES             | YES *2   | YES *4        | YES         | wss://<host>:443/websocket | TCP <host>:1883      |
